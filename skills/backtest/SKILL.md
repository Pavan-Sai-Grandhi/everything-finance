...
python3 <skill-dir>/scripts/backtest.py \
  --spec artifacts/strategies/ema-pullback-swing.yml \
  --symbols RELIANCE,TCS,HDFCBANK --years 5 --capital 500000 \
  --out artifacts/YYYY-MM-DD/backtest
```
...
Save the summary to `artifacts/YYYY-MM-DD/backtest-<spec-name>.md` alongside the script's CSV outputs. End with: backtests describe the past; live edge degrades — position sizing discipline is what survives.
